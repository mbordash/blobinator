...
class Blobinator {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Blobinator_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-blobinator-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-blobinator-i18n.php';
	 ...
	 *
	 * Uses the Blobinator_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new Blobinator_i18n();
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Blobinator_Admin( $this->get_plugin_name(), $this->get_version() );

		$this->loader->add_action( 'admin_enqueue_scripts', $plugin_admin, 'enqueue_styles' );
		$this->loader->add_action( 'admin_enqueue_scripts', $plugin_admin, 'enqueue_scripts' );

        // this is for loading the plugin in the main menu under Tools
        $this->loader->add_action( 'admin_menu', $plugin_admin, 'add_blobinator_settings_page' );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Blobinator_Loader    Orchestrates the hooks of the plugin.
	 */
